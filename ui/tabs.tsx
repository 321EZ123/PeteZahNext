...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex flex-row items-center justify-start [perspective:1000px] relative overflow-visible no-visible-scrollbar max-w-full w-full top-2!",
          containerClassName
        )}
      >
        {propTabs.map((tab, idx) => (
          ...
          >
            ...
            <span className="relative blocktext-white">{tab.title}</span>
          </button>
        ))}
      </div>
      <FadeInDiv
